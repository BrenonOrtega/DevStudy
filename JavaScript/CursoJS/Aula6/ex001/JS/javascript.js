...
var teste = alert(`alo srº ${nome} como está?`)

//até o momento não funcional.
function myfunction(){
var x = document.getElementById("p1").innerHTML = "Paragraph change"
}

document.getElementById("p1").innerHTML = "Hello Dolly.";
